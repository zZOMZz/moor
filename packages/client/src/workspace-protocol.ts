...
import { workspaceTargetSchema } from '@moor/protocol/workspace-target';
import { id, runtimeWorkspaceSchema } from '@moor/protocol/protocol';
import { hostNotificationEventSchema } from '@moor/protocol/notification-protocol';
