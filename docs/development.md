...
| Agent 本机设置与角色   | [本机设置](../src/runtime/agent-settings.ts)、[固定版本](../src/runtime/session-agent.ts)、[角色主机](../src/runtime/session-roles.ts)、[角色页面](../src/web/roles.ts) | [本机 CLI/IPC](../tests/agent-settings-host.test.ts)、[角色主机](../tests/session-roles.test.ts)、[角色中转](../tests/roles-relay.test.ts)、[草稿事务](../tests/roles-cache.test.ts)、[真实 app](../tests/roles-app.test.ts) |
