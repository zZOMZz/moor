...
import type { SkillDetail, SkillsList, SkillsRead } from '../src/skills-protocol';
import { skillInstruction } from '../src/web/skills';
import { SecureSkillsController, type SecureSkillsContext } from '../src/web/secure-skills';
