...
import type { SecureSkillsContext, SecureSkillsDependencies } from '../src/web/secure-skills';
import type { SecureSkillsUiHandle } from '../src/web/secure-skills-ui';
...
test('secure Skills UI displays safe complete content, manually appends, retries errors and clears on target departure', async (t) => {
  ...
  const { SecureSkillsUI } = await import('../src/web/secure-skills-ui');
