...
import type { SecureGitUiHandle } from '../src/web/secure-git-ui';
import type { SecureGitOpenOptions } from '../src/web/secure-git';
import { fixture, target, version, oid, signal } from './support/secure-git-fixture';
...
async function mount(t: TestContext, f = fixture()) {
  ...
  const { SecureGitUI } = await import('../src/web/secure-git-ui');
  t.mock.method(
    crypto.subtle,
    'digest',
