...
import { EncryptedCliClient } from '../../apps/cli/src/encrypted-client';
import { parseCliArgs, type CliArgs } from '../../apps/cli/src/args';
...
import { EncryptedBridgeClient, EncryptedHostError } from '@moor/client/encrypted-bridge-client';
import type { EncryptedCatalog } from '@moor/e2ee/encrypted-bridge-protocol';
