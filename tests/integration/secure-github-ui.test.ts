...
import type { SecureGithubUiHandle } from '../../apps/web/src/features/github/secure-github-ui';
import type { SecureGithubMode } from '../../apps/web/src/features/github/secure-github';
import { fixture, target, version, head, base, signal } from '../fixtures/secure-github-fixture';
...
async function mount(t: TestContext, f = fixture()) {
  ...
  const { SecureGithubUI } = await import('../../apps/web/src/features/github/secure-github-ui');
  t.mock.method(
    crypto.subtle,
    'digest',
