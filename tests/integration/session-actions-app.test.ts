...
import type { SessionSummary } from '../../apps/web/src/features/sessions/navigation';
      ...
      `,
          ...
          builder.onLoad({ filter: /\/apps\/web\/src\/app\/app\.ts$/ }, async (args) => ({
            ...
            contents:
              ...
              '\nexport { loadSession, loadSessions, manageSession, openSession }; export { disposeUI } from "../components/ui";\n',
          }));
        },
      },
    ],
