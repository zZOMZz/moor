...
import {
  ...
  verifySigningFacts,
  writeReleaseReport,
} from '../../scripts/release/mac-release.mjs';
...
async function fixture(t: TestContext) {
  ...
  const files = {
    ...
    [`${appRoot}/main/main.cjs`]: '// synthetic desktop main',
    [`${appRoot}/main/mcp-settings.cjs`]: '// synthetic private MCP IPC controller',
    [`${appRoot}/main/google-auth.cjs`]: '// synthetic Google desktop sign-in controller',
    [`${appRoot}/preload/preload.cjs`]: '// synthetic finite preload',
    [`${appRoot}/settings/settings.html`]: '<title>Synthetic settings</title>',
...
const injected = {
  ...
  entitlementsDirectory: resolve('scripts/release/mac-entitlements'),
};
