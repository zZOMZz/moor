...
import { CliState, requestVersion } from '../../apps/cli/src/state';
import { secureOriginal, type SecureCliTarget } from '@moor/client/secure-operation';
...
import { sessionOperationSchema } from '@moor/protocol/session-control-protocol';
