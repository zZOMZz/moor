...
import { gitWorkspaceKey, type GitTarget } from '../../apps/web/src/features/git/git-workspace';
...
import { SESSION_TASKS_FEATURE } from '@moor/protocol/task-protocol';
import { syntheticTaskPlan } from '../fixtures/task-plan';
import { previewAnnotationKey } from '../../apps/web/src/features/preview/project-preview';
      ...
      `,
          ...
          builder.onLoad({ filter: /\/apps\/web\/src\/app\/app\.ts$/ }, async (args) => ({
            ...
            contents:
              ...
              '\nexport { attention, loadSession, openSession, openAttention, openGitWorkspace, openSkills, openRoles, openTasks, openMcp, saveComposerDraft, currentAttachments, currentPreviewAnnotations }; export { disposeUI } from "../components/ui";\n',
          }));
          builder.onLoad(
            { filter: /\/apps\/web\/src\/features\/attention\/attention-ui\.tsx$/ },
            async (args) => ({
              loader: 'tsx',
              resolveDir: resolve('apps/web/src/features/attention'),
