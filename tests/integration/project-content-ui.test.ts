...
import type { ProjectContentPanelProps } from '../../apps/web/src/features/files/project-content-ui';
import type { ProjectDiffReference } from '@moor/protocol/project-content-protocol';
