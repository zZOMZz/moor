...
import { sessionInformation } from '../../apps/web/src/features/interactions/interactions';
...
function fixture(
  ...
  supportSteer = true,
  currentEvents: SessionEventState = { version: 1, plans: [], commands: commands.commands },
) {
