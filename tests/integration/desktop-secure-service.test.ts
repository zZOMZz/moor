...
import { E2eeChannel, newChannelChallenge, type EncryptedRecord } from '@moor/e2ee/e2ee-channel';
...
async function fixture(
  ...
  const fingerprint = (await import('@moor/e2ee/e2ee-pairing')).fingerprintRequest;
