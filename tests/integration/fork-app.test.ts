...
} from '../../apps/web/src/features/notifications/notification-navigation';
        ...
        setup(builder) {
          ...
          builder.onLoad({ filter: /\/apps\/web\/src\/app\/app\.ts$/ }, async (args) => ({
            ...
            contents:
              ...
              '\nexport {openSessionFork,currentSessionFork,openSession,sendTurn,addAttachments,currentAttachments};export {disposeUI} from "../components/ui";',
          }));
        },
      },
    ],
