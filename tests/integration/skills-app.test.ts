        ...
        setup(builder) {
          ...
          builder.onLoad({ filter: /\/apps\/web\/src\/app\/app\.ts$/ }, async (args) => ({
            ...
            contents:
              ...
              '\nexport {openSkills,currentSkills,resetSkills,appendSkillDraft,openSession,sendTurn,currentAttachments,fillAgentCommand,persistComposerDraft};export {disposeUI} from "../components/ui";',
          }));
        },
      },
    ],
