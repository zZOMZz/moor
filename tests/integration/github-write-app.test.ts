...
import { githubWriteRequestVersion } from '../../apps/web/src/features/github/github-write';
...
import { Flock, LoroDoc, delta, encode, metas, mirror, putMeta } from '@moor/session/model';
        ...
        setup(builder) {
          ...
          builder.onLoad({ filter: /\/apps\/web\/src\/app\/app\.ts$/ }, async (args) => ({
            ...
            contents:
              ...
              '\nexport {openGithub,openGithubWrite,currentGithubWrite,openSession,sendTurn};export {disposeUI} from "../components/ui";',
          }));
        },
      },
    ],
