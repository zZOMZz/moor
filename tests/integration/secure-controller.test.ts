...
import { SecureWorkspaceController } from '../../apps/web/src/platform/secure-controller';
...
} from '@moor/client/desktop-secure-protocol';
import { encryptedCatalogSchema } from '@moor/e2ee/encrypted-bridge-protocol';
import type { AgentCallbacks } from '@moor/host/agents/driver';
import { PERMISSION_REVIEW_FEATURE } from '@moor/protocol/permission-review';
import { SecureAttachments } from '../../apps/web/src/features/attachments/secure-attachments';
import { SecureGithubController } from '../../apps/web/src/features/github/secure-github';
import {
  secureGitTarget,
  SecureScopedStorage,
} from '../../apps/web/src/platform/secure-scoped-storage';
import { SecureRunOptionsStore } from '../../apps/web/src/platform/secure-run-options';
import { githubKey } from '../../apps/web/src/features/github/github';
import { githubWriteKey } from '../../apps/web/src/features/github/github-write';
import {
  githubActionSchema,
  GITHUB_FEATURE,
  SECURE_GITHUB_AUTHORITY_FEATURE,
} from '@moor/protocol/github-protocol';
import { githubWriteActionSchema } from '@moor/protocol/github-write-protocol';
import type { SecureCliTarget } from '@moor/client/secure-operation';
import { MCP_FEATURE } from '@moor/protocol/mcp-protocol';
import { SECURE_TURN_AUTHORITY_FEATURE } from '@moor/protocol/task-protocol';
import { syntheticCapabilities } from '../fixtures/agent-capabilities';
import { LoroDoc, decode, delta, mirror } from '@moor/session/model';
...
import { SecureSkillsController } from '../../apps/web/src/features/skills/secure-skills';
...
import { previewFrame, previewVersion } from '../fixtures/preview-fixture';
...
test('all new execution paths respect durable original Fork requests, including an older product mapping', async (t) => {
  ...
  const { sessionForkKey } = await import('../../apps/web/src/features/fork/session-fork');
  const operation = {
    target: inner,
