...
import { Flock, LoroDoc, decode, delta, encode, metas, mirror, putMeta } from '@moor/session/model';
        ...
        setup(builder) {
          ...
          builder.onLoad({ filter: /\/apps\/web\/src\/app\/app\.ts$/ }, async (args) => ({
            ...
            contents:
              ...
              '\nexport {loadDevices,openSession,closeProjectContent,openSessionSearch,closeSessionSearch};export const testSearch=(query,scope)=>runSessionSearch(searchPanel,query,scope);export {disposeUI} from "../components/ui";',
          }));
        },
      },
    ],
