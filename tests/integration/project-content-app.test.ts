      ...
      `,
          ...
          builder.onLoad({ filter: /\/apps\/web\/src\/app\/app\.ts$/ }, async (args) => ({
            ...
            contents:
              ...
              '\nexport { loadSession, loadDevices, openSession, openProjectContent, openCurrentProjectFile, openProjectDiffFile, closeProjectContent, sendTurn }; export { disposeUI } from "../components/ui";\n',
          }));
        },
      },
    ],
