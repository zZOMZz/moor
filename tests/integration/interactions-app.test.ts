...
import { Flock, LoroDoc, delta, metas, mirror, putMeta } from '@moor/session/model';
import { syntheticCapabilities } from '../fixtures/agent-capabilities';
import {
  interactionKey,
  questionDraftKey,
} from '../../apps/web/src/features/interactions/interactions';
import { questionRequestSchema } from '@moor/protocol/interaction-protocol';
        ...
        setup(builder) {
          ...
          builder.onLoad({ filter: /\/apps\/web\/src\/app\/app\.ts$/ }, async (args) => ({
            ...
            contents:
              ...
              '\nexport {loadSession,loadDevices,openSession,answerActiveQuestion,retryInteraction,dismissInteraction,submitSteer,closeCurrentInteractionPanel,cancelTurn,sendTurn};export {disposeUI} from "../components/ui";',
          }));
        },
      },
    ],
