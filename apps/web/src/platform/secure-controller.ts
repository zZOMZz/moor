...
import { encryptedCatalogSchema, type EncryptedCatalog } from '@moor/client/encrypted-catalog';
import { productCanonicalJson, type EncryptedProductTarget } from '@moor/client/encrypted-product';
import {
  secureOriginal,
  secureTargetSchema,
...
import { agentSchema, sessionActionSchema } from '@moor/protocol/protocol';
...
import {
  SecureAttachments,
  type SecureAttachmentDraft,
} from '../features/attachments/secure-attachments';
import { SKILLS_FEATURE } from '@moor/protocol/skills-protocol';
import { MCP_FEATURE } from '@moor/protocol/mcp-protocol';
import type { SecureMcpDraft } from '../features/mcp/secure-mcp';
import { SECURE_TURN_AUTHORITY_FEATURE } from '@moor/protocol/task-protocol';
import { GITHUB_FEATURE, SECURE_GITHUB_AUTHORITY_FEATURE } from '@moor/protocol/github-protocol';
...
import type { PreviewAnnotation } from '../features/preview/project-preview';
import { readSecureGithubExecutionBlock } from '../features/github/secure-github';
import { readSecureGitExecutionBlock } from '../features/git/secure-git';
import {
  readSecureForkExecutionBlock,
  readSecureForkResource,
  readSecureForkChild,
  readSecureForkOperation,
} from '../features/fork/secure-fork';
import {
...
import { attachmentBytes } from '../features/attachments/attachments';
