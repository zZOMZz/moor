...
import { serverOrigin, withAbort } from '@moor/client/node/http';
...
const attentionFeaturesSchema = z.array(id).max(64).optional();
const meSchema = z
  .object({
    owner: z.string().min(1).max(160),
    actor: actorSchema.optional(),
    attentionFeatures: attentionFeaturesSchema,
