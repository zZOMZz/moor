...
import { snapshotSecureInput } from './secure-input.cjs';
import { DeviceManager } from '@moor/e2ee/node/device-manager';
import { fingerprintRequest } from '@moor/e2ee/e2ee-pairing';
import { verifyPublicTrustEntry } from '@moor/e2ee/trust-publication';
import {
...
import { e2eeIdSchema, e2eeOriginSchema, type VerifiedTrust } from '@moor/e2ee/e2ee-trust';
...
} from '@moor/e2ee/desktop-client-protocol';
